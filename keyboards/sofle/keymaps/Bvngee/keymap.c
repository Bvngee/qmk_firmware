...
[_BASE] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, XXXXXXX,            KC_MUTE, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_DEL,
             KC_LALT, KC_LGUI, KC_LCTL, LT(_LOWER,KC_SPC),KC_ENT,  LT(_UPPER,KC_BSPC), KC_LSFT, KC_TAB, KC_RGUI, KC_RALT
),
...
//   _______, KC_AT
  _______, _______, _______, _______, _______, _______,                    _______, _______, _______, _______, _______, _______,
 S(KC_GRV),KC_PLUS, KC_7,    KC_8,    KC_9,    KC_EQL,                     KC_EXLM, KC_LCBR, KC_RCBR, KC_QUES, KC_AMPR, KC_HASH,
  KC_GRV,  KC_MINS, KC_4,    KC_5,    KC_6,    KC_0,                       KC_CIRC, KC_LPRN, KC_RPRN, KC_DLR,  KC_ASTR, KC_PIPE,
  _______, KC_UNDS, KC_1,    KC_2,    KC_3,    KC_DOT, _______,   _______, KC_AT,   KC_LBRC, KC_RBRC, KC_PERC, KC_BSLS, _______,
                  _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
),
[_UPPER] = LAYOUT( // F-keys go on upper layer
  XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                       KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
  QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                    C(KC_LEFT),KC_PGDN,KC_PGUP,C(KC_RIGHT),KC_HOME,KC_F12,
  QK_REBOOT,XXXXXXX,XXXXXXX, KC_INS,  KC_PSCR, XXXXXXX,                     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,  KC_END, _______,
  _______, XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, _______,   _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, _______,
                  _______, _______, _______, _______, _______,        _______, _______, _______, _______, _______
)
};
// clang-format off
